    ...
    /** @ignore */ this.routes = [
      {
        ...
        meta: {
          post: { description: `Create a new ${this.collectionName}` },
          get: { 
            description: `Retrieve all ${this.collectionName}`, 
            parameters: defaultParams,
            requestBody: {
              description: `${this.schemaName} data`,
              content: { "application/json": { schema: { $ref: `#/components/schemas/${this.schemaName}` } } }
            }
          }
        },
      },
      {
        ...
        meta: {
          get: { description: `Retrieve ${this.schemaName} schema` }
        },
      },
      {
        route: '/:_id',
        ...
        meta: {
          put: { description: `Replace an existing ${this.schemaName} document` },
          get: { description: `Retrieve a single ${this.schemaName} document` },
          patch: { description: `Update an existing ${this.schemaName} document` },
          delete: { description: `Delete an existing ${this.schemaName} document` }
        }
      },
      {
        route: '/query',
        ...
        meta: {
          post: { description: `Query all ${this.collectionName}`, parameters: defaultParams }
        }
      }
    ];
  }
