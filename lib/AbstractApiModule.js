...
class AbstractApiModule extends AbstractModule {
   ...
   * @param {external:mongodb~InsertOneOptions} mongoOptions Options to be passed to the MongoDB function
   ...
   * @param {external:mongodb~FindOptions} mongoOptions Options to be passed to the MongoDB function
   * @return {Promise} Resolves with DB data
   */
   ...
   * @param {external:mongodb~FindOneAndUpdateOptions} mongoOptions Options to be passed to the MongoDB function
   * @return {Promise} Resolves with DB data
   */
   ...
   * @param {external:mongodb~DeleteOptions} mongoOptions Options to be passed to the MongoDB function
   * @return {Promise} Resolves with DB data
   */
