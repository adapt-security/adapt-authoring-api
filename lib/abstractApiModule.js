...
class AbstractApiModule extends AbstractModule {
  ...
  async _init() {
    ...
    this.insertHook.tap((data, opts) => this.handleValidation(data, opts));
    this.updateHook.tap((undefined, data, opts) => this.handleValidation(data, opts));
  }
  /**
  ...
  */
  ...
  async handleValidation(data, { schemaName, validate, strictValidate }) {
    if(validate) Object.assign(data, await this.validate(schemaName, data, strictValidate));
  }
  /**
  * Validates data
