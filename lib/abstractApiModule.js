...
class AbstractApiModule extends AbstractModule {
  ...
  * @return {Promise} Resolves with DB data
  */
  async find(filter, options, mongoOptions) {
    this.setDefaultOptions(options);
    const mongodb = await this.app.waitForModule('mongodb');
    return mongodb.find(options.collectionName, filter, mongoOptions);
  }
  /**
  ...
  * @return {Promise} Resolves with DB data
  */
  async update(filter, data, options, mongoOptions) {
    this.setDefaultOptions(options);
    const mongodb = await this.app.waitForModule('mongodb');
    return mongodb.update(options.collectionName, filter, await this.validate(options.schemaName, data), mongoOptions);
  }
  /**
  ...
  * @return {Promise} Resolves with DB data
  */
  async replace(filter, data, options, mongoOptions) {
    this.setDefaultOptions(options);
    const mongodb = await this.app.waitForModule('mongodb');
    return mongodb.replace(options.collectionName, filter, await this.validate(options.schemaName, data), mongoOptions);
  }
  /**
  ...
  * @return {Promise} Resolves with DB data
  */
  async delete(filter, options, mongoOptions) {
    this.setDefaultOptions(options);
    const mongodb = await this.app.waitForModule('mongodb');
    return mongodb.delete(options.collectionName, filter, mongoOptions);
  }
}
