...
class AbstractApiModule extends AbstractModule {
  ...
  */
  async insert(schemaName, collectionName, data) {
    ...
    return mongodb.insert(collectionName, await this.validate(schemaName, data));
  }
  /**
  ...
  */
  async update(schemaName, collectionName, filter, data) {
    const mongodb = await this.app.waitForModule('mongodb');
    return mongodb.update(collectionName, filter, await this.validate(schemaName, data));
  }
  /**
  ...
  */
  async replace(schemaName, collectionName, filter, data) {
    const mongodb = await this.app.waitForModule('mongodb');
    return mongodb.replace(collectionName, filter, await this.validate(schemaName, data));
  }
  /**
